...
class ResourceIds {
 ...
 private:
  ...
  ///
  /// \param increment_quantity An double of how many unit resources to add.
  /// \return Void.
  ...
  ///
  /// \param decrement_quantity An double of how many unit resources to remove.
  /// \return Void.
  ...
  /// An int to track any pending decrements in capacity that weren't executed because
