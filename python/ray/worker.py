...
def create_resource(resource_name, capacity, client_id=None):
    ...
    return global_worker.raylet_client.create_resource(resource_name, capacity, client_id)      #TODO(romilb): Should this return none when client id not exist?
...
def delete_resource(resource_name, client_id=None):
    ...
    if client_id != None:
        ...
        client_id = NIL_CLIENT_ID
    return global_worker.raylet_client.delete_resource(resource_name, client_id)
