...
def check_and_update_resources(num_cpus, num_gpus, resources):
    ...
    for _, resource_quantity in resources.items():
        ...
        if resource_quantity > ray_constants.MAX_RESOURCE_QUANTITY:
            raise ValueError("Resource quantities must be at most {}. Received {}.".format(
                ray_constants.MAX_RESOURCE_QUANTITY, resources))
...
def start_raylet(redis_address,
    ...
    num_cpus_static = static_resources["CPU"] if "CPU" in static_resources else 0
